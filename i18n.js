...
(function () {
  ...
  var translations = {
    es: {
      ...
      "services.premium.price": "Desde $2.00",
      "services.premium.note": "Por ciclo de lavado",
      ...
      "services.dry.price": "Desde $0.25",
      "services.dry.note": "Por ciclo de secado",
      ...
      "services.fold.note": "Por servicio",
      "services.dryClean.badge": "Servicio especializado",
      "services.dryClean.title": "Lavado en Seco",
      "services.dryClean.desc": "Cuidado especializado para prendas delicadas. Trae tus prendas y nosotros nos encargamos del resto.",
      "services.dryClean.cat1": "Trajes",
      "services.dryClean.cat2": "Vestidos",
      "services.dryClean.cat3": "Abrigos",
      "services.dryClean.cat4": "Y más",
      "services.dryClean.price": "Consultar precio según prenda",
      "services.dryClean.cta": "Preguntar por WhatsApp",
      "services.disclaimer": "*Todos los precios son variables y el valor final depende de las especificaciones de cada servicio.",

      // --- Experiencia y confort (index.html) ---
      "experience.eyebrow": "Experiencia y confort",
      "experience.title": "La mejor experiencia de lavandería en Ambato",
      "experience.desc": "Relájate mientras cuidamos tu ropa. Disfruta de un ambiente agradable con café recién elaborado, sánduches y snacks mientras esperas tu ciclo de lavado, o utiliza nuestro servicio por encargo y retira tu ropa limpia y lista para llevar.",
      "experience.feature1": "Café recién elaborado",
      "experience.feature2": "Sánduches y snacks",
      "experience.feature3": "Servicio por encargo: retira tu ropa lista para llevar",
      ...
      "privacy.s1.intro": "Easy Lav no cuenta con sistema de cuentas de usuario, registro de clientes ni base de datos de pedidos. La información que podemos llegar a tener sobre ti es mínima:",
      "privacy.s1.li1": "<span class='font-semibold'>Cookies técnicas de sesión</span>, únicamente para recordar tu preferencia de idioma (español/inglés) y si ya aceptaste el aviso de cookies del sitio.",
      "privacy.s1.li2": "<span class='font-semibold'>Datos de contacto</span> (nombre, teléfono y/o correo electrónico), solo si tú decides escribirnos de forma voluntaria por WhatsApp, correo electrónico o el formulario de contacto del sitio.",
      ...
      "privacy.s2.intro": "Usamos la información de contacto que nos compartas voluntariamente exclusivamente para:",
      "privacy.s2.li1": "Responder tus consultas realizadas por WhatsApp, teléfono, correo electrónico o el formulario de contacto del sitio.",
      "privacy.s2.li2": "Coordinar contigo detalles puntuales sobre un servicio que hayas solicitado, como el lavado en seco o el servicio por encargo.",
      "privacy.s2.li3": "Cumplir obligaciones legales o contables aplicables a un negocio en Ecuador, como la emisión de comprobantes de venta.",
      ...
      "privacy.s3.li1": "<span class='font-semibold'>Cookies necesarias:</span> permiten que el sitio funcione correctamente, como recordar tu preferencia de idioma y si ya aceptaste este aviso de cookies. No pueden desactivarse.",
      ...
      "terms.s1.text": "Easy Lav ofrece servicios de lavado, secado y doblado de prendas mediante equipos profesionales Speed Queen, ya sea de forma autónoma (autoservicio) o con la asistencia de nuestro personal, además de un servicio de lavado en seco para prendas delicadas.",
      ...
      "terms.s4.text": "Los precios publicados en el sitio web son referenciales y pueden variar según el tipo de servicio, la cantidad de prendas y las especificaciones de cada solicitud. El valor final se confirma antes de procesar tu pedido en el local.",
    ...
    en: {
      ...
      "services.premium.price": "From $2.00",
      "services.premium.note": "Per wash cycle",
      ...
      "services.dry.price": "From $0.25",
      "services.dry.note": "Per drying cycle",
      ...
      "services.fold.note": "Per service",
      "services.dryClean.badge": "Specialty service",
      "services.dryClean.title": "Dry Cleaning",
      "services.dryClean.desc": "Specialized care for delicate garments. Bring us your items and we'll take care of the rest.",
      "services.dryClean.cat1": "Suits",
      "services.dryClean.cat2": "Dresses",
      "services.dryClean.cat3": "Coats",
      "services.dryClean.cat4": "And more",
      "services.dryClean.price": "Price quoted per garment",
      "services.dryClean.cta": "Ask us on WhatsApp",
      "services.disclaimer": "*All prices are variable, and the final amount depends on the specifications of each service.",

      // --- Experience & comfort (index.html) ---
      "experience.eyebrow": "Experience & comfort",
      "experience.title": "The best laundry experience in Ambato",
      "experience.desc": "Relax while we take care of your clothes. Enjoy a pleasant atmosphere with freshly brewed coffee, sandwiches, and snacks while you wait for your wash cycle, or use our on-demand service and pick up your laundry clean and ready to go.",
      "experience.feature1": "Freshly brewed coffee",
      "experience.feature2": "Sandwiches & snacks",
      "experience.feature3": "On-demand service: pick up your laundry ready to go",
      ...
      "privacy.s1.intro": "Easy Lav does not have a user account system, a customer registry, or an order database. The information we may have about you is minimal:",
      "privacy.s1.li1": "<span class='font-semibold'>Technical session cookies</span>, used only to remember your language preference (Spanish/English) and whether you've already accepted the site's cookie notice.",
      "privacy.s1.li2": "<span class='font-semibold'>Contact details</span> (name, phone number, and/or email address), only if you choose to write to us voluntarily via WhatsApp, email, or the site's contact form.",
      ...
      "privacy.s2.intro": "We use the contact information you voluntarily share with us exclusively to:",
      "privacy.s2.li1": "Respond to inquiries you make via WhatsApp, phone, email, or the site's contact form.",
      "privacy.s2.li2": "Coordinate specific details with you about a service you've requested, such as dry cleaning or our on-demand service.",
      "privacy.s2.li3": "Comply with legal or accounting obligations applicable to a business in Ecuador, such as issuing sales receipts.",
      ...
      "privacy.s3.li1": "<span class='font-semibold'>Necessary cookies:</span> allow the site to work properly, such as remembering your language preference and whether you've already accepted this cookie notice. These cannot be disabled.",
      ...
      "terms.s1.text": "Easy Lav offers washing, drying, and folding services using professional Speed Queen equipment, either on a self-service basis or with the assistance of our staff, in addition to a dry cleaning service for delicate garments.",
      ...
      "terms.s4.text": "Prices published on the website are for reference only and may vary depending on the type of service, the number of garments, and the specifications of each request. The final amount is confirmed before processing your order in store.",
